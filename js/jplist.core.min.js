/**
 * jPList - jQuery Data Grid Controls 5.2.0.269 - http://jplist.com
...
(function() {
    var d = function(a, b) {
            ...
            if (a && a.controller && a.controller.collection) {
                e = a.controller.collection.dataitems.length;
                jQuery.isNumeric(b.index) && 0 <= b.index && b.index <= a.controller.collection.dataitems.length && (e = Number(b.index));
                b.$item && a.controller.collection.addDataItem(b.$item, a.controller.collection.paths, e);
                if (b.$items)
                    if (c = b.$items, jQuery.isArray(c))
                        for (var d = c.length - 1; 0 <= d; d--) a.controller.collection.addDataItem(c[d], a.controller.collection.paths, e);
                    else c = c.find(a.options.itemPath).addBack(a.options.itemPath),
                        jQuery(c.get().reverse()).each(function() {
                            a.controller.collection.addDataItem(jQuery(this), a.controller.collection.paths, e)
                        });
        ...
        b = function(a, b) {
            var e;
            a && a.controller && a.controller.collection && (b.$item && (a.controller.collection.delDataitem(b.$item), b.$item.remove()), b.$items && (e = b.$items, jQuery.isArray(b.$items) && (e = jQuery(b.$items).map(function() {
                return this.toArray()
            })), a.controller.collection.delDataitems(e), e.remove()), a.observer.trigger(a.observer.events.unknownStatusesChanged, [!1]))
        },
        c = function(a, e, c) {
            switch (e) {
                case "add":
        ...
        a = function(a) {
            a.observer.on(a.observer.events.knownStatusesChanged, function(b, e) {
                var c;
                if (e && (a.history.addStatuses(e), (c = a.panel.mergeStatuses(e)) && 0 < c.length && (a.storage.save(c), a.controller.renderStatuses(c, a.history.getLastStatus()), c = !1, e))) {
                    for (var d = 0; d < e.length; d++)
                        if (e[d].isAnimateToTop) {
                            c = !0;
                            break
                        }
                    c && (c = jQuery(a.options.animateToTop).offset().top, jQuery("html, body").animate({
                        scrollTop: c
                    }, a.options.animateToTopDuration))
                }
            });
            a.observer.on(a.observer.events.unknownStatusesChanged, function(b,
                e) {
                var c;
                c = a.panel.getStatuses(e);
                0 < c.length && (a.storage.save(c), a.controller.renderStatuses(c, a.history.getLastStatus()))
            });
        ...
        e = function(b, e) {
            ...
            c.controller = new jQuery.fn.jplist.DOMController(c.$root, c.options, c.observer,
                c.panel.paths);
            a(c);
...
(function() {
    var d = function(b, c) {
        b.statusesQueue.push(c);
        b.statusesQueue.length > b.options.historyLength && b.statusesQueue.shift()
    };
    jQuery.fn.jplist.History = function(b, c, a) {
        this.options = c;
        this.observer = a;
        this.$root = b;
        this.statusesQueue = [];
    ...
    jQuery.fn.jplist.History.prototype.addStatus = function(b) {
        d(this, b)
    };
    jQuery.fn.jplist.History.prototype.addStatuses = function(b) {
        for (var c = 0; c < b.length; c++) d(this, b[c])
    };
    ...
    jQuery.fn.jplist.History.prototype.addList = function(b) {
        this.listStatusesQueue.push(b);
        this.listStatusesQueue.length >
            this.options.historyLength && this.listStatusesQueue.shift()
    };
...
(function() {
    jQuery.fn.jplist.StatusDTO = function(d, b, c, a, e, h, f, g) {
        this.action = b;
        this.name = d;
        this.type = c;
        this.data = a;
...
(function() {
        ...
        if (jQuery.isArray(b))
            for (var d = 0; d < b.length; d++)
                if ((c = b[d]) && c.data && c.data.sortGroup && jQuery.isArray(c.data.sortGroup) && 0 < c.data.sortGroup.length)
                    for (var f =
                            0; f < c.data.sortGroup.length; f++) e = new jQuery.fn.jplist.StatusDTO(c.name, c.action, c.type, c.data.sortGroup[f], c.inStorage, c.inAnimation, c.isAnimateToTop, c.inDeepLinking), a.push(e);
                else a.push(c);
        return a
    };
    ...
    var d = function(b, c, a, e) {
        for (var d = [], f, g = 0; g < b.length; g++) f = b[g], f[c] === a && (e && (f.initialIndex = g), d.push(f));
        return d
    };
    jQuery.fn.jplist.StatusesService.add = function(b, c, a) {
        ...
        if (0 === b.length) b.push(c);
            ...
            f = !1;
            for (var g = 0; g < h.length; g++) e = h[g], e.type === c.type && (f = !0, a && (b[e.initialIndex] = c));
            f || b.push(c)
        }
    }
})();
(function() {
    ...
    jQuery.fn.jplist.DTOMapperService.filters.TextFilter = function(d, b) {
        ...
        return jQuery.fn.jplist.FiltersService.textFilter(d.data.value, c, b, d.data.ignore, d.data.mode)
    };
...
(function() {
    var d = function(b, c) {
        for (var a, e, d = [], f = 0; f < c.length; f++) a = c[f], e = b.$item.find(a.jqPath).addBack(a.jqPath), 0 < e.length && (a = new jQuery.fn.jplist.DataItemMemberModel(e, a), d.push(a));
...
(function() {
    var d = function(a, b) {
        ...
        b = function(a, b) {
            ...
            if (0 < c.length) {
                for (var f = 0; f < c.length; f++)
                    if (e = c[f], e.data && (jQuery.isNumeric(e.data.currentPage) && (d =
        ...
        c = function(a, c) {
            var b = [],
                b = jQuery.fn.jplist.StatusesService.getSortStatuses(c);
            0 < b.length && (jQuery.fn.jplist.SortService.doubleSort(b, a.dataview), a.observer.trigger(a.observer.events.listSorted, [c, a]))
        },
        a = function(a) {
            return jQuery(a.dataview).map(function(a, c) {
                return c.jqElement.get()
            })
        },
        e = function(a) {
            return jQuery(a.dataitems).map(function(a, c) {
                return c.jqElement.get()
            })
        },
        h = function(a) {
        ...
        f = function(a, c) {
            for (var b, e = -1, d, h = 0; h < a.dataitems.length; h++)
                if (b = a.dataitems[h], b = jQuery.fn.jplist.HelperService.getOuterHtml(b.jqElement), d = jQuery.fn.jplist.HelperService.getOuterHtml(c), b === d) {
                    e = h;
                    break
                }
            return e
        ...
        g = function(a, c) {
            var b;
            b = f(a, c); - 1 !== b && (a.dataitems.splice(b,
                1), a.observer.trigger(a.observer.events.dataItemRemoved, [c, a.dataitems]))
        },
        k = function(a, c) {
            c.each(function() {
                g(a, jQuery(this))
        ...
        l = function(a, c, b, e) {
            c = new jQuery.fn.jplist.DataItemModel(c, b, e);
            a.dataitems.splice(e, 0, c);
            a.observer.trigger(a.observer.events.dataItemAdded, [c, a.dataitems])
        },
        m = function(a, c, b, e, d) {
            for (var h; b < c.length; b++) h = c.eq(b), 3 !== h.get(0).nodeType && (l(a, h, e, b), b + 1 < c.length && 0 === b % 50 && window.setTimeout(function() {
                m(a, c, b, e, d)
            }, 0))
        };
    jQuery.fn.jplist.Dataitems = function(a, c, b) {
        this.dataitems = [];
        this.dataview = [];
        this.paths = b;
        this.observer = a;
        0 < c.length && (m(this, c, 0, b, 0), h(this));
    ...
    jQuery.fn.jplist.Dataitems.prototype.addPaths = function(a) {
        for (var c = 0; c < this.dataitems.length; c++) this.dataitems[c].addPaths(a);
        h(this)
    };
    ...
    jQuery.fn.jplist.Dataitems.prototype.addDataItem =
        function(a, c, b) {
            l(this, a, c, b)
        };
    jQuery.fn.jplist.Dataitems.prototype.addDataItems = function(a, c, b) {
        m(this, a, 0, c, b);
        h(this)
    };
    ...
    jQuery.fn.jplist.Dataitems.prototype.dataviewToString = function() {
        var a, c = "",
            b;
        for (b = 0; b < this.dataview.length; b++) a = this.dataview[b], c += a.html;
        return c
    }
})();
(function() {
...
(function() {
    jQuery.fn.jplist.FiltersService.dateFilter = function(d, b, c, a, e, h) {
        for (var f, g, k = [], l = 0; l < e.length; l++)
            if (f = e[l], g = f.findPathitem(a)) jQuery.isNumeric(d) && jQuery.isNumeric(b) && jQuery.isNumeric(c) ? (g = jQuery.fn.jplist.HelperService.formatDateTime(g.text, h)) && jQuery.isFunction(g.getFullYear) && (g.setHours(0), g.setMinutes(0), g.setSeconds(0), g.getFullYear() === d && g.getMonth() === b && g.getDate() === c && k.push(f)) : k.push(f);
        return k
    }
})();
(function() {
    jQuery.fn.jplist.FiltersService.dateRangeFilter = function(d, b, c, a, e, h, f, g, k) {
        for (var l = [], m, n, q, p, r = 0; r < b.length; r++)
            if (m = b[r], n = m.findPathitem(d)) q = !jQuery.isNumeric(a) || !jQuery.isNumeric(e) || !jQuery.isNumeric(h), p = !jQuery.isNumeric(f) || !jQuery.isNumeric(g) || !jQuery.isNumeric(k), q || p ? l.push(m) : (p = jQuery.fn.jplist.HelperService.formatDateTime(n.text, c)) && jQuery.isFunction(p.getFullYear) && (n = new Date(a, e, h), q = new Date(f, g, k), p.setHours(0), p.setMinutes(0), p.setSeconds(0), p >= n && p <= q && l.push(m));
        return l
    }
})();
(function() {
...
(function() {
    jQuery.fn.jplist.FiltersService.rangeFilter = function(d, b, c, a, e, h) {
        for (var f = [], g, k = [], l, m = 0; m < b.length; m++) k = [], g = b[m], (c = g.findPathitem(d)) && 0 < c.$element.length && (c.$element.each(function() {
            var a = Number($(this).text().replace(/[^-0-9\.]+/g, ""));
            isNaN(a) || k.push(a)
        }), 0 < k.length && (a = Math.max.apply(Math, k), c = Math.min.apply(Math, k), l = !0, jQuery.isNumeric(e) && e > c && (l = !1), jQuery.isNumeric(h) && a > h && (l = !1), l && f.push(g)));
        return f
    }
})();
(function() {
    var d = function(a) {
            var c = [],
                b;
            if (a)
                for (var d = 0; d < a.length; d++)(b = jQuery.trim(a[d])) && c.push(b);
            return c
        },
        b = function(a, c) {
            var b = !1,
            ...
            f = d(f);
            if (0 < f.length)
                for (var b = -1 !== a.indexOf(f[0]), g = 1; g < f.length; g++) b = b || -1 !== a.indexOf(f[g]);
            return b
        },
        c = function(a, c) {
            var h, f, g = !1;
            ...
            if (0 < h.length) {
                f = h[0];
                for (var g = -1 === f.indexOf(" or ") ? -1 !== a.indexOf(f) : b(a, f), k = 1; k < h.length; k++) f = h[k], g = -1 === f.indexOf(" or ") ? g && -1 !== a.indexOf(f) : g && b(a, f)
            }
            return g
        };
    jQuery.fn.jplist.FiltersService.advancedSearchParse =
        function(a, e) {
            e = jQuery.trim(e);
            if (-1 === e.indexOf(" or ") && -1 === e.indexOf(" and ") && -1 === e.indexOf("not ")) return -1 !== a.indexOf(e);
            var h, f, g = !1;
            h = e.split("not ");
            h = d(h);
            if (0 < h.length) {
                f = h[0];
                for (var g = -1 === f.indexOf(" and ") ? -1 === f.indexOf(" or ") ? -1 === a.indexOf(f) : b(a, f) : c(a, f), k = 1; k < h.length; k++) f = h[k], g = -1 === f.indexOf(" and ") ? (g = -1 === f.indexOf(" or ") ? g && -1 === a.indexOf(f) : g && b(a, f)) && b(a, f) : g && c(a, f)
            }
            return g
        }
})();
(function() {
    jQuery.fn.jplist.FiltersService.textGroupFilter = function(d, b, c, a, e, h) {
        ...
        for (var n = 0; n < e.length; n++)
            if (c = e[n], g = c.findPathitem(k), "default" === k.jqPath) h.push(c);
            else if (g)
            if (g = jQuery.fn.jplist.HelperService.removeCharacters(g.text, a), "or" === b)
                for (m = 0; m < d.length; m++) {
                    if (f = d[m], f = jQuery.fn.jplist.HelperService.removeCharacters(f, a), jQuery.fn.jplist.FiltersService.advancedSearchParse(g, f)) {
                        h.push(c);
                        break
                    }
                } else {
                    l = [];
                    for (m = 0; m < d.length; m++) f = d[m], f = jQuery.fn.jplist.HelperService.removeCharacters(f, a), jQuery.fn.jplist.FiltersService.advancedSearchParse(g, f) && l.push(f);
...
(function() {
    jQuery.fn.jplist.FiltersService.textFilter = function(d, b, c, a, e) {
        var h, f, g = [],
            k;
        e = e || "contains";
        for (var l = 0; l < c.length; l++)
            if (h = c[l], f = h.findPathitem(b), "default" === b.jqPath) g.push(h);
            else if (f) switch (f = jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(f.text, a)), k = jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(d, a)), e) {
            case "startsWith":
                f.startsWith(k) && g.push(h);
                break;
            case "endsWith":
                f.endsWith(k) && g.push(h);
                break;
            case "advanced":
                jQuery.fn.jplist.FiltersService.advancedSearchParse(f,
                    k) && g.push(h);
                break;
            case "equal":
                f === k && g.push(h);
            ...
            for (var m = 0; m < a.length; m++)
                if (k = a[m], h = k.pathObj)
                    if ("default" === h.jqPath) {
                        l = !0;
                        break
                    } else if (h = d.findPathitem(h)) switch (h = jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(h.text, b)), g = jQuery.trim(jQuery.fn.jplist.HelperService.removeCharacters(k.text,
                b)), k.mode) {
                case "startsWith":
                    h.startsWith(g) && (l = !0);
                    break;
                case "endsWith":
                    ...
                    break;
                case "advanced":
                    jQuery.fn.jplist.FiltersService.advancedSearchParse(h, g) && (l = !0);
                    break;
                case "equal":
                    h === g && (l = !0);
                    break;
...
(function() {
    jQuery.fn.jplist.SortService.textHelper = function(d, b, c, a, e) {
        d = d.findPathitem(a);
        b = b.findPathitem(a);
        return d && b ? (e ? (a = new RegExp(e, "ig"), e = d.text.toString().replace(a, "").toLowerCase(), d = b.text.toString().replace(a, "").toLowerCase()) : (e = d.text.toString().toLowerCase(), d = b.text.toString().toLowerCase()), e == d ? 0 : "asc" == c ? e > d ? 1 : -1 : e < d ? 1 : -1) : 0
    };
    jQuery.fn.jplist.SortService.text = function(d, b, c, a) {
        c.sort(function(c, h) {
            return jQuery.fn.jplist.SortService.textHelper(c, h, d, b, a)
        })
    }
})();
(function() {
    var d = function(b, c, a, e) {
        ...
        if (0 < a.length) {
            f = a[e];
            if ("default" !== f.data.path) {
                if (g = jQuery.fn.jplist.DTOMapperService.sort[f.data.type], jQuery.isFunction(g) && (h = g(f, b, c), 0 === h && jQuery.isArray(f.data.additionalPaths) && 0 < f.data.additionalPaths.length))
                    for (var k = 0; k < f.data.additionalPaths.length; k++) h = jQuery.extend(!0, {}, f), h.data.path = f.data.additionalPaths[k], h = g(h, b, c)
            } else f = b.index, g = c.index, h = f === g ? 0 : isNaN(f) ? 1 : isNaN(g) ? -1 : f - g;
            0 === h && e + 1 < a.length && (h = d(b, c, a, e + 1))
        }
        return h
    };
...
(function() {
    jQuery.jplist.sort = function(d, b, c, a, e, h, f) {
        ...
        d.sort([b]);
        return "html" === f ? d.dataviewToString() : d.dataviewToJqueryObject()
    }
})();
(function() {
    var d = function(c, a) {
            ...
            if ("{month}" == c) {
                a = a.toLowerCase();
                if ("january" === a || "jan" === a || "jan." === a) b = 0;
                if ("february" === a || "feb" === a || "feb." === a) b = 1;
                if ("march" === a || "mar" === a || "mar." === a) b = 2;
                if ("april" == a || "apr" === a || "apr." === a) b = 3;
                "may" === a && (b = 4);
                if ("july" == a || "jun" === a || "jun." === a) b = 5;
                if ("april" === a || "jul" === a || "jul." === a) b = 6;
                if ("august" === a || "aug" === a || "aug." === a) b = 7;
                if ("september" === a || "sep" === a || "sep." === a) b = 8;
                if ("october" === a || "oct" === a || "oct." === a) b = 9;
                if ("november" === a ||
                    "nov" === a || "nov." === a) b = 10;
                if ("december" === a || "dec" === a || "dec." === a) b = 11;
                null === b && (b = parseInt(a, 10), isNaN(b) || b--)
    ...
    jQuery.fn.jplist.HelperService.getOuterHtml = function(b) {
        ...
        if (b && b[0] && b[0].tagName) {
            ...
            for (var a =
                    a + ("<" + b), f = 0; f < e.length; f++) e[f].nodeValue && (a += " " + e[f].nodeName + "=", a += '"' + e[f].nodeValue + '"');
            a = a + ">" + d;
            a += "</" + b + ">"
        }
        return a
...
(function() {
    var d = function(b, c, a, e) {
        var d = c.dataitemsToJqueryObject(),
            f = c.dataviewToJqueryObject(),
            g = !1,
            k = jQuery.extend(!0, {}, b.options, {
                duration: 0
            });
        0 >= d.length || 0 >= f.length ? (b.$noResults.removeClass("jplist-hidden"), b.$itemsBox.addClass("jplist-hidden"), jQuery.isFunction(b.redrawCallback) && b.redrawCallback(c, f, a)) : (b.$noResults.addClass("jplist-hidden"), b.$itemsBox.removeClass("jplist-hidden"), b.effect && jQuery.fn.jplist.animation ? (e && !e.inAnimation && (g = !0), e = g ? k : b.options, jQuery.fn.jplist.animation.drawItems(e,
            b.$itemsBox, d, f, b.effect,
            function() {
                jQuery.isFunction(b.redrawCallback) && b.redrawCallback(c, f, a)
            }, b.observer)) : (d.detach(), b.$itemsBox.append(f), jQuery.isFunction(b.redrawCallback) && b.redrawCallback(c, f, a)));
        return f
    };
    jQuery.fn.jplist.DOMView = function(b, c, a, d, h, f, g) {
        this.options = c;
        this.$root = b;
        this.observer = a;
        this.redrawCallback = f;
        this.effect = g;
        this.$itemsBox = b.find(d).eq(0);
        this.$noResults = b.find(h)
    };
...
(function() {
        ...
        c = function(b) {
            ...
            if ("cookies" === b.options.storage || "localstorage" === b.options.storage && jQuery.fn.jplist.LocalStorageService.supported())
                if ("cookies" === b.options.storage &&
                    ...
                    for (var d = [], g = 0; g < c.length; g++) c[g].inStorage && d.push(c[g]);
    ...
    jQuery.fn.jplist.PanelController = function(a, c, d, g) {
        this.options = c;
        this.$root = a;
        this.history = d;
        this.observer = g;
...
(function() {
    ...
    jQuery.fn.jplist.ControlFactory.prototype.create = function(d, b) {
        ...
        (e = d.attr("data-control-storage")) && "false" === e.toString() && (f = !1);
        (e = d.attr("data-control-animation")) && "false" === e.toString() && (g = !1);
...
(function() {
    var d = function(a, b) {
            for (var c = [], d, g = 0; g < a.controls.length; g++) d = a.controls[g], jQuery.isFunction(d.getStatus) && (d = d.getStatus(b)) && jQuery.fn.jplist.StatusesService.add(c, d, !1);
            return c
        },
        b = function(a, b, c, d, g, k) {
            (b = (new jQuery.fn.jplist.ControlFactory(g, k, c, d)).create(b, a)) && a.controls.push(b);
            return b
        },
        c = function(a, c, d, f, g, k) {
            c.each(function() {
                b(a, jQuery(this), d, f, g, k)
            })
        };
    ...
    jQuery.fn.jplist.ControlsCollection.prototype.merge =
        function(a, b) {
            ...
            f = [];
            c = d(this, a);
            for (var g = 0; g < c.length; g++) jQuery.fn.jplist.StatusesService.add(f, c[g], !1);
            if (b)
                for (c = 0; c < b.length; c++) jQuery.fn.jplist.StatusesService.add(f, b[c], !0);
            return f
        };
    ...
    jQuery.fn.jplist.ControlsCollection.prototype.setDeepLinks = function(a, b) {
        ...
        for (l = 0; l <
            ...
            var m = [];
            g = void 0;
            for (var n = 0; n < this.controls.length; n++) g = this.controls[n], g.name === d && m.push(g);
            d = m;
            for (m = 0; m < d.length; m++) g = d[m], jQuery.isFunction(g.getStatusByDeepLink) && (g = g.getStatusByDeepLink(c.propName, c.propValue)) && jQuery.fn.jplist.StatusesService.add(k, g, !1)
        }
    ...
    jQuery.fn.jplist.ControlsCollection.prototype.setStatuses = function(a, b) {
        for (var c, d, g = [], k = 0; k <
            ...
            c = a[k];
            d = !1;
            for (var l = 0; l < g.length; l++) g[l].name === c.name && g[l].action === c.action && (d = !0, g[l].statuses.push(c));
            d || g.push({
                name: c.name,
                action: c.action,
                statuses: [c]
        ...
        for (l = 0; l < g.length; l++)
            if (c = g[l], c.statuses && 0 < c.statuses.length) {
                d = c.statuses[0].name;
                for (var k = c.statuses[0].action, m = [], n = void 0, q = 0; q < this.controls.length; q++) n = this.controls[q], n.name === d && n.action === k && m.push(n);
                d = m;
    ...
    jQuery.fn.jplist.ControlsCollection.prototype.getDeepLinksUrl = function(a) {
        ...
        var c = [],
            ...
            g;
        g = this.controls;
        for (var k = 0; k < g.length; k++) b = g[k], jQuery.isFunction(b.getDeepLink) && (d = jQuery.trim(b.getDeepLink())), "" !== d && -1 === jQuery.inArray(d, c) && c.push(d);
        return b = c.join(a)
    };
        ...
        for (var a, b = [], c = [], d = 0; d < this.controls.length; d++)
            if (a =
                ...
                for (a.getPaths(b), a = 0; a < b.length; a++) {
                    for (var g = c, k = b[a], l = void 0, m = !1, n = 0; n < g.length; n++)
                        if (l = g[n], l.isEqual(k, !0)) {
                            m = !0;
                            break
                        }
                    m || c.push(b[a])
    ...
    jQuery.fn.jplist.ControlsCollection.prototype.add = function(a, c, d, f, g) {
        b(this, a, c, d, f, g)
    };
    jQuery.fn.jplist.ControlsCollection.prototype.addList = function(a, b, d, f, g) {
        c(this, a, b, d, f, g)
    }
})();
(function() {
    ...
    jQuery.fn.jplist.DropdownControl = function(a, b, d, f) {
        return new c(a, b, d, f)
    }
})();
(function() {
